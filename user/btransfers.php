    ...
    <body class="sb-nav-fixed">
                    ...
                    <div class="row">
                        ...
                        <div class="card mb-4">
                            <div class="card-header">
                                <i class="fas fa-chart-area mr-1"></i>Branch Stock Transfers
                            </div>
                            <div class="card-body">
                                <div class="row">
                                    <div class="col">
                                        <button class="btn btn-primary" @click="newstocktran">New Stock Transfer</butoon>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col">
        ...
        <script>
            ...
            var app=new Vue({
                ...
                methods:{
                    newstocktran:async function(){
                        app.auth=await app.chkauth("Inventory","Save");
                        if(app.auth){
                            window.location.assign("newstocktran");
                        }
                    }
                }
            });            
