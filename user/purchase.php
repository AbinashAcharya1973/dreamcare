                    ...
                    <div class="row">
                        ...
                        <div class="card mb-4">
                            <div class="card-header">
                                <i class="fas fa-chart-area mr-1"></i>Purchase                             
                            </div>
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-md-3 col-sm-12">
                                        <div class="form-group">
                                            <label class="label">Last Purchase Slno</label>
                                            <input type="text" class="form-control" ref="txtpslno"/>
                                        </div>
                                    </div>
                                    <div class="col-md-3 col-sm-12">
                                        <div class="form-group">
                                            <label class="label">Purchase Date</label>
                                            <input type="date" class="form-control" ref="txtpdate" @keyup.enter="txtpdate_enter"/>
                                        </div>
                                    </div>
                                    <div class="col-md-3 col-sm-12">
                                        <div class="form-group">
                                            <label class="label">Invoice No</label>
                                            <input type="text" class="form-control" ref="txtinvno" @keyup.enter="txtinvno_enter"/>
                                        </div>
                                    </div>
                                    <div class="col-md-3 col-sm-12">
                                        <div class="form-group">
                                ...
                                <div class="row">
                                    <div class="col-md-3 col-sm-12">
                                        <div class="form-group">
                                            <label class="label">Supplier/Party Cr</label>
                                            <select class="form-control" ref="txtpartycr" v-model="selectedParty" @change="txtparty_change">
                                                <option v-for="(party,index) in CrPartyList" :value='index'>{{party.Party}}</option>
                                            </select> <button class="btn btn-primary" @click="newpartycr" >New Supplier</button>
                                        </div>
                                    ...
                                    <div class="col-md-3 col-sm-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" ref="txtorderno" @keyup.enter="txtorderno_enter"/>
                                        </div>
                                    </div>
                                    <div class="col-md-3 col-sm-12">
                                        <div class="form-group">
                                            <label class="label">Order Date</label>
                                            <input type="date" class="form-control" ref="txtorderdate" @keyup.enter="txtorderdate_enter"/>
                                        </div>
                                    </div>
                                    <div class="col-md-3 col-sm-12">
                                        <div class="form-group">
                                            <label class="label">Way Bill/LR Details</label>
                                            <input type="text" class="form-control" ref="txtwaybill" @keyup.enter="txtwaybill_enter"/>
                                        </div>
                                    </div>
                                ...
                                <div class="row border border-primary" v-if="NewParty">
                                    <div class="col">
                                        ...
                                        <div class="col-md-3 col-sm-12">
                                            <div class="form-group">
                                                <label class="label">Supplier/Party Cr Name</label>
                                ...
                                <div class="row">
                                    <div class="col-md-12 col-sm-12">
                                        ...
                                        <small class="text-primary">{{subcategory}},HSN:{{hsn}},MRP:{{MRP}}</small>                                                                                
                                    </div>
                                </div>
                                <div class="row">
                                ...
                                <div class="row">
                                    <div class="col text-center">
                                        <button class="btn btn-primary" @click="save">Save</button> <button class="btn btn-primary" @click="printslip" >Print Product Slips</button>
                                    </div>
                                </div>
                            </div>
