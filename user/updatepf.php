...
$sql = "update members set emailid='".$data[0]['emailid']."',mname='".$data[0]['mname']."',address='".$data[0]['address']."',city_village='".$data[0]['city_village']."',pin='".$data[0]['pin']."',aadhar='".$data[0]['aadhar']."',bankac='".$data[0]['bankac']."',ifsc='".$data[0]['ifsc']."',mobileno='".$data[0]['mobileno'] ."' where memid=" . $data[0]['memid'];
$conn->query($sql);
$data = array();
