    ...
    <body class="sb-nav-fixed">
                    ...
                    <div class="row">
                        ...
                        <div class="card mb-4">
                            <div class="card-header">
                                <i class="fas fa-users mr-1"></i>Party Debtors [Customers]
                            </div>
                            <div class="card-body">
                            <div class="row">
                                    <div class="col text-left">
                                        <button class="btn btn-primary btn-sm btn-outline" @click='newcustomer'><i class="fas fa-user-plus mr-1"></i></button>
                                    </div>
                                    <br>
                                    <hr>
                                </div>
                            ...
                            <div class="row">
                                <div class="col">
                                    <table id="partycrtb" class="table table-striped table-bordered" style="width:100%">
                                        ...
                                        <tbody>
                                            <tr v-for='(customer,index) in DrPartyList'>
        ...
        <script>
            ...
            var app=new Vue({
                ...
                methods:{
                    newcustomer:async function(){
						app.auth=await app.chkauth("Master Data","New Customer");
						if(app.auth){
                    ...
                    edit:async function(id){
						...
						if(app.auth){
							var tempid=app.DrPartyList[id].AccId;
							localStorage.tempaccid=tempid;
							window.location.assign('editcustomer');
						}else{
							alert("Access Denied");
						}
                    }
