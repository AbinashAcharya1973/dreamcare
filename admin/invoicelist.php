                    ...
                    <div class="row">
                        ...
                        <div class="card mb-4">
                            <div class="card-header">
                                <i class="fas fa-chart-area mr-1"></i>Invoice List
                            </div>
                            <div class="card-body">
                                <div class="row">
                                    <div class="col">
                                ...
                                <div class="row">
                                    ...
                                    <table class="table table-bordered table-striped table-hover">
                                        <thead>
                                            <tr>
                                                <th>Invoice No</th><th>Invoice Date</th><th>Customer</th><th>Total Qty</th><th>Gross</th><th>Discount</th><th>Taxable</th><th>Tax Amt</th><th>Net Amount</th>
                                            </tr>
                                        </thead>
                                        <tbody>
                                            <tr v-for="inv in InvoiceList">
                                                <td>{{inv.InvNo}}</td><td>{{inv.InvDate}}</td><td>{{inv.Party}}</td><td>{{inv.TotalQty}}</td><td>{{inv.TotalGross}}</td><td>{{inv.totaldiscount}}</td><td>{{inv.TotalGross-inv.totaldiscount}}</td><td>{{inv.TaxAmount}}</td><td>{{inv.GrandTotal}}</td>
                                            </tr>
                                        </tbody>
                                    </table>
                                    </div>
            ...
            var app=new Vue({
                ...
                methods:{
                  newinvoice:async function(){
                    ...
                    if(app.auth){
                        windows.location.assign("bnewinvoice");
                    }*/
                    window.location.assign("newinvoice");
                  }  
                }
            });            
        </script>
