        ...
        <div class="sb-sidenav-menu">
            <div class="nav" id="menu">
                ...
                <div class="collapse" id="collapseLayouts_v" aria-labelledby="headingOne" data-parent="#sidenavAccordion">
                    ...
                    <nav class="sb-sidenav-menu-nested nav">
                        <a class="nav-link" href="invledger.php">Investment Ledger</a>
                    </nav>
                    <nav class="sb-sidenav-menu-nested nav">
                        <a class="nav-link" href="withdrawreq.php">Withdraw Requests</a>
                    </nav>
                    <nav class="sb-sidenav-menu-nested nav">
                        <a class="nav-link" href="payment.php">Payment/Transfer Voucher</a>
                    </nav>
                    <nav class="sb-sidenav-menu-nested nav">
                        <a class="nav-link" href="receive.php">Receipt Voucher</a>
                    </nav>
                    <nav class="sb-sidenav-menu-nested nav">
                        <a class="nav-link" href="payment.php">Payment Voucher</a>
                    </nav>
                </div>            
