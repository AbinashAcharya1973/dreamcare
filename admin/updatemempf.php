...
$sql = "update members set mname='".$data['mname']."',address='".$data['address']."',city_village='".$data['city_village']."',pin='".$data['pin']."',aadhar='".$data['aadhar']."',bankac='".$data['bankac']."',ifsc='".$data['ifsc']."',mobileno='".$data['mobileno'] ."' where membercode='" . $data['membercode']."'";
$conn->query($sql);
$data = array();
