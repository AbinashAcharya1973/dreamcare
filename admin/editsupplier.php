    ...
    <body class="sb-nav-fixed">
                    ...
                    <div class="row">
                        ...
                        <div class="card mb-4">
                            <div class="card-header">
                                <i class="fas fa-user mr-1"></i>Supplier Edit                                
                            </div>
                            <div class="card-body">
                            <div class="row">
        ...
        <script>
            ...
            var app=new Vue({
                ...
                mixins: [mainMixin],
                mounted:function(){
                    this.tempid=localStorage.tempaccid;
                    axios.post('gtstatecode')
                    .then(function(response){
                        app.StateCodes=response.data;                                
                    })
                    axios.post('gtcrparty',{id:this.tempid})
                            .then(function(response){
                                app.PartyDetails=response.data;
                                app.party=app.PartyDetails[0].Party;
                                app.address1=app.PartyDetails[0].Address;
                                app.address2=app.PartyDetails[0].Address2;
                                app.pincode=app.PartyDetails[0].PINCode;
                                app.phoneno=app.PartyDetails[0].Phone;
                                app.emailid=app.PartyDetails[0].Email;
                                app.gstn=app.PartyDetails[0].GSTN;
                                app.obalance=app.PartyDetails[0].OBalance;
                                app.obalancetype=app.PartyDetails[0].BalanceType;
                                app.obalance=app.PartyDetails[0].OBalance;
                                app.scode=app.PartyDetails[0].StateCode;
                                app.tempacid=app.PartyDetails[0].AccId;
                            })
                ...
                methods:{
                    save:async function(){
						...
						if(app.auth){
							app.PartyCr.tempacid=app.tempacid;
							app.PartyCr.party=app.party;
							app.PartyCr.address1=app.address1;
							app.PartyCr.address2=app.address2;
							app.PartyCr.pincode=app.pincode;
							app.PartyCr.phoneno=app.phoneno;
							app.PartyCr.emailid=app.emailid;
							app.PartyCr.gstn=app.gstn;
							app.PartyCr.obalance=app.obalance;
							app.PartyCr.obalancetype=app.obalancetype;
							app.PartyCr.scode=app.scode;
							//app.PartyCr.ulsid=app.ulsid;
							let senddata=app.toFormData(app.PartyCr);
							axios.post('svsundce',senddata)
							.then(function(response){
								var result=response.data;
									//alert(result);                                 
									alert ("Supplier Saved Successfuly");
									window.location.assign('partycr');
									/*if(ans){
										window.location.assign('newsupplier.html');
									}else{
										window.location.assign('partycr.html');
									}*/
							})
							.catch(function(error){ alert(error);})
                          }else{
